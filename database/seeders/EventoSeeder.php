    ...
    public function run(): void
    {
        $eventos = [
            [
                ...
                'poster_url'       => 'https://raw.githubusercontent.com/ivanespi57/arena2/main/public/images/eventos/rock.jpg',
                'fecha'            => '2026-06-15',
                'hora'             => '20:00',
            ],
            [
                ...
                'poster_url'       => 'https://raw.githubusercontent.com/ivanespi57/arena2/main/public/images/eventos/coparey.jpg',
                'fecha'            => '2026-07-20',
                'hora'             => '21:00',
            ],
            [
                ...
                'poster_url'       => 'https://raw.githubusercontent.com/ivanespi57/arena2/main/public/images/eventos/electronica.avif',
                'fecha'            => '2026-08-10',
                'hora'             => '19:00',
            ],
            [
                ...
                'descripcion_larga' => 'Representación de una obra clásica del teatro español con los mejores actores.',
                'poster_url'       => 'https://raw.githubusercontent.com/ivanespi57/arena2/main/public/images/eventos/clasico.jpg',
                'fecha'            => '2026-09-05',
                'hora'             => '18:30',
            ],
        ];
