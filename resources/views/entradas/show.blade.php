...
<div class="card" style="max-width: 600px; margin: 0 auto;">
    ...
    <h2 style="font-size:1.4rem; margin-bottom:0.25rem;">{{ $entrada['evento']['nombre'] }}</h2>
    ...
    <div style="background:#f8f9fa; border-radius:8px; padding:1.25rem; margin-bottom:1.5rem;">
        <table style="width:100%; border-collapse:collapse;">
            <tr>
                ...
                <td style="padding:0.4rem 0; font-weight:600;">{{ $entrada['asiento']['nombre'] }}</td>
            </tr>
            <tr>
                <td style="padding:0.4rem 0; color:#666;">Sector</td>
                <td style="padding:0.4rem 0; font-weight:600;">{{ $entrada['asiento']['sector'] }}</td>
            </tr>
            <tr>
                <td style="padding:0.4rem 0; color:#666;">Fila</td>
                <td style="padding:0.4rem 0; font-weight:600;">{{ $entrada['asiento']['fila'] }}</td>
            </tr>
            <tr>
                <td style="padding:0.4rem 0; color:#666;">Número</td>
                <td style="padding:0.4rem 0; font-weight:600;">{{ $entrada['asiento']['numero'] }}</td>
            </tr>
            <tr>
                <td style="padding:0.4rem 0; color:#666;">Precio pagado</td>
                <td style="padding:0.4rem 0; font-weight:600; color:#27ae60;">{{ $entrada['precio_pagado'] }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding:0.4rem 0; color:#666;">Fecha de compra</td>
                <td style="padding:0.4rem 0;">{{ $entrada['fecha_compra'] }}</td>
            </tr>
        </table>
    </div>
